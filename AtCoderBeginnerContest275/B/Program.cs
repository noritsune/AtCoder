...
namespace KyoPro {
    ...
    public class Solver
    {
        ...
        public void Solve()
        {
            ...
            var biA = new BigInteger(A); var biB = new BigInteger(B); var biC = new BigInteger(C);
            var biD = new BigInteger(D); var biE = new BigInteger(E); var biF = new BigInteger(F);

            var biABC = biA * biB * biC;
            var biDEF = biD * biE * biF;

            var biABCsubDEF = biABC - biDEF;

            Console.WriteLine(biABCsubDEF % MOD);
        }
