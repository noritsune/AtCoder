...
public class Solver {
    public void Solve()
    {
        ...
        for (int i = 0; i < Q; i++)
        {
            var LxRxLyRyLzRz = Ria();
            var Lx = LxRxLyRyLzRz[0] - 1; var Rx = LxRxLyRyLzRz[1] - 1;
            var Ly = LxRxLyRyLzRz[2] - 1; var Ry = LxRxLyRyLzRz[3] - 1;
            var Lz = LxRxLyRyLzRz[4] - 1; var Rz = LxRxLyRyLzRz[5] - 1;

            var ans = rui[Rx + 1, Ry + 1, Rz + 1]
                        - rui[Lx    , Ry + 1, Rz + 1]
                        - rui[Rx + 1, Ly    , Rz + 1]
                        - rui[Rx + 1, Ry + 1, Lz    ]
                        + rui[Rx + 1, Ly    , Lz    ]
