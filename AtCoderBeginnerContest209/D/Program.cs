    ...
    public class Sol{
        ...
        public void Solve(){
            ...
            while(q.Count > 0) {
                ...
                {
                    int currentDist = minDists[minVert] + 1;
            ...
            foreach (int[] cd in cds)
            {
                ...
                int dist = minDists[d] - minDists[c];

                Console.WriteLine(dist % 2 == 0 ? "Town" : "Road");
            }
            
            Console.ReadLine();
        }

        int getShortestDist(Graph<int> graph, int start, int goal) {
