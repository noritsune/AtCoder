...
namespace AtCoder {
    ...
    public class Solver {
        public void Solve()
        {
            ...
            var swappedSsFirst = new HashSet<string>
            {
                "" + S[1] + S[0] + S[2],
                "" + S[0] + S[2] + S[1],
                "" + S[2] + S[1] + S[0],
            ...
            var swappedSsSecond = new HashSet<string>();
            foreach (var swappedS in swappedSsFirst)
            {
                swappedSsSecond.Add("" + swappedS[1] + swappedS[0] + swappedS[2]);
                swappedSsSecond.Add("" + swappedS[0] + swappedS[2] + swappedS[1]);
                swappedSsSecond.Add("" + swappedS[2] + swappedS[1] + swappedS[0]);
            }

            Console.WriteLine(swappedSsSecond.Contains(T) ? "Yes" : "No");
        }
