...
class Sol{
	...
	public void Solve(){
        ...
        ABs.Sort((int[] ABs_1, int[] ABs_2) => {
            if(ABs_1[0] != ABs_2[0]) {
                return ABs_1[0] - ABs_2[0];
            } else {
                return ABs_1[1] - ABs_2[1];
            }
        });

        bool[] isUsedColors = new bool[400001];
        foreach (var AB in ABs)
        {
            ...
            if(!isUsedColors[A]) {
                ...
                // if(isUsedColors[A]) isDualColors[A] = true;
                // if(isUsedColors[B]) isDualColors[B] = true;
                isUsedColors[B] = true;
            }
        }
        ...
        //     if(!isUsedColors[A] && isDualColors[B]) {
        //         isUsedColors[A] = true;
        //     } else if(!isUsedColors[B] && isDualColors[A]){
        //         isUsedColors[B] = true;
        //     }
        // }
		
		Console.WriteLine(isUsedColors.Count((value) => value));
		Console.ReadLine();
	}
