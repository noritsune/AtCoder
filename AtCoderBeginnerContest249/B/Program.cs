...
namespace KyoPro {
    ...
    public class Solver {
        public void Solve()
        {
            ...
            bool isExistUpperChar = S.Any(c => c >= 'A' && c <= 'Z');
            bool isExistLowerChar = S.Any(c => c >= 'a' && c <= 'z');
            bool isDifferentAll = S.Distinct().Count() == S.Length;
            
            Console.WriteLine(isExistUpperChar && isExistLowerChar && isDifferentAll ? "Yes": "No");
        }
