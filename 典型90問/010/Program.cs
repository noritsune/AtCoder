...
namespace AtCoder {
    ...
    public class Solver {
        public void Solve() {
            ...
            for (int i = 0; i < N; i++) CPs.Add(ria());
            
            var ruiseki1 = new int[N + 1];
            var ruiseki2 = new int[N + 1];
            for (int i = 0; i < N; i++)
            {
                ...
                if (cls == 1) ruiseki1[i + 1] += score;
                else          ruiseki2[i + 1] += score;
            }
            ...
            for (int i = 0; i < Q; i++)
            {
                ...
                int scoreSum1 = ruiseki1[R] - ruiseki1[L - 1];
                int scoreSum2 = ruiseki2[R] - ruiseki2[L - 1];
