...
namespace AtCoder {
    ...
    public class Solver {
        ...
        private static int ri(){return int.Parse(Console.ReadLine() ?? string.Empty);}
        private static long rl(){return long.Parse(Console.ReadLine() ?? string.Empty);}
        private static double rd(){return double.Parse(Console.ReadLine() ?? string.Empty);}
        private static BigInteger rb(){return BigInteger.Parse(Console.ReadLine() ?? string.Empty);}
        private static string[] rsa(char sep=' '){return Console.ReadLine()?.Split(sep);}
        private static int[] ria(char sep=' '){return Array.ConvertAll(Console.ReadLine()!.Split(sep),int.Parse);}
        private static long[] rla(char sep=' '){return Array.ConvertAll(Console.ReadLine()!.Split(sep),long.Parse);}
        private static double[] rda(char sep=' '){return Array.ConvertAll(Console.ReadLine()!.Split(sep),double.Parse);}
        private static BigInteger[] rba(char sep=' '){return Array.ConvertAll(Console.ReadLine()!.Split(sep),BigInteger.Parse);}
        private static int[] generateNums(int num, int N){return Enumerable.Repeat(num, N).ToArray();}
        private static int[] generateSuretsu(int N){return Enumerable.Range(0, N).ToArray();}
