            ...
            for (int i = 0; i < N; i++)
            {
                ...
                for (int j = i + 1; j < N; j++)
                {
                    ...
                    for (int k = j + 1; k < N; k++)
                    {
                        ...
                        if(Equals(pos1, pos2) || Equals(pos1, pos3) || Equals(pos2, pos3)) continue;
                        
                        long a = (pos2.y - pos1.y) * (pos3.x - pos1.x);
                        long b = (pos3.y - pos1.y) * (pos2.x - pos1.x);
