...
namespace AtCoder {
    ...
    public class Solver {
        public void Solve()
        {
            ...
            string toL = S.Substring(0, L- 1);
            string LtoR = S.Substring(L - 1, R - L + 1);
            string fromR = S.Substring(R);
            string reversedLtoR = new string(LtoR.Reverse().ToArray());

            Console.WriteLine(toL + reversedLtoR + fromR);
        }
