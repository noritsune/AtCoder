...
namespace util {
    ...
    public class Sol{
        ...
        public void Solve()
        {
            ...
            for (int i = 0; i < T; i++) cases.Add(rla());
            ...
            foreach (var case_ in cases)
            {
                ...
                // 3の棒2本と4の棒1本で作る
                long stick334Cnt = Math.Min(cnt4, cnt3 / 2);
                cnt4 -= stick334Cnt;
                cnt3 -= stick334Cnt * 2;
                ans += stick334Cnt;
                
                // 3の棒2本と2の棒2本で作る
                long stick3322Cnt = Math.Min(cnt2 / 2, cnt3 / 2);
                cnt2 -= stick3322Cnt * 2;
                cnt3 -= stick3322Cnt * 2;
                ans += stick3322Cnt;
                
                // 4の棒2本と2の棒1本で作る
                long stick442Cnt = Math.Min(cnt4 / 2, cnt2);
                cnt2 -= stick442Cnt;
                cnt4 -= stick442Cnt * 2;
                ans += stick442Cnt;
                
                // 4の棒1本と2の棒3本で作る
                long stick4222Cnt = Math.Min(cnt4, cnt2 / 3);
                cnt2 -= stick4222Cnt * 3;
                cnt4 -= stick4222Cnt;
                ans += stick4222Cnt;
                
                // 4の棒2本と2の棒1本で作る
                long stick2by5Cnt = cnt2 / 5;
                cnt2 -= stick2by5Cnt * 5;
                ans += stick2by5Cnt;
