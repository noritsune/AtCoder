...
namespace util {
    ...
    public class Sol{
        ...
        public void Solve(){
            ...
            List<Vector2> indexAndScores = new List<Vector2>();
            for (int i = 0; i < N; i++)
            {
                indexAndScores.Add(new Vector2(i + 1, As[i]));
            }

            indexAndScores.Sort((a, b) => b._y - a._y);
            
            Console.WriteLine(indexAndScores[1]._x);
            Console.ReadLine();
        }
