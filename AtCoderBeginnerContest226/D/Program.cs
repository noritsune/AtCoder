        ...
        public void Solve()
        {
            ...
            for (int i = 0; i < N - 1; i++)
            {
                for (int j = i + 1; j < N; j++)
                {
                    ...
                    var magicPlus = new [] { a, b };
                    var magicMinus = new [] { -a, -b };
                    magics.Add(string.Join(" ", magicPlus));
                    magics.Add(string.Join(" ", magicMinus));
                }
            }
            
            Console.WriteLine(magics.Count);
        }
