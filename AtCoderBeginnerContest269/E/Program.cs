    ...
    public class Solver {
        public void Solve()
        {
            ...
            while(left != right)
            {
                ...
                Console.WriteLine($"? {1} {N} {left} {mid}");
                
                var c = Rl();
                if (c == -1) throw new Exception();
                
                var expectedC = mid - left + 1;
                if (c == expectedC) left = mid + 1;
                else right = mid;
            ...
            while(top != bottom)
            {
                ...
                Console.WriteLine($"? {top} {mid} {1} {N}");
                
                var c = Rl();
                if (c == -1) throw new Exception();
                
                var expectedC = mid - top + 1;
                if(c == expectedC) top = mid + 1;
                else bottom = mid;
