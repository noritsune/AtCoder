...
class Sol{
	...
	public void Solve(){
        ...
        for (int i = 0; i < N; i++)
        {
            ...
            chebyChef = Math.Max(chebyChef, abs);
        }

        Console.WriteLine(manhattan);
        Console.WriteLine(Math.Sqrt(euclid));
        Console.WriteLine(chebyChef);
		Console.ReadLine();
	}

    static double EuclidianDistance(int[] point)
    {
        double sum = 0;
        foreach (int scalar in point)
        {
            sum += Math.Pow(Math.Abs(scalar), 2);
        }
	...
	static BigInteger rl(){return BigInteger.Parse(Console.ReadLine());}
	static double rd(){return double.Parse(Console.ReadLine());}
	static BigInteger rb(){return BigInteger.Parse(Console.ReadLine());}
	static String[] rsa(char sep=' '){return Console.ReadLine().Split(sep);}
	static int[] ria(char sep=' '){return Array.ConvertAll(Console.ReadLine().Split(sep),e=>int.Parse(e));}
	static BigInteger[] rla(char sep=' '){return Array.ConvertAll(Console.ReadLine().Split(sep),e=>BigInteger.Parse(e));}
