...
namespace AtCoder {
    ...
    public class Solver {
        public void Solve()
        {
            ...
            int sameNumSameIndexCnt = 0;
            int sameNumDiffIndexCnt = 0;
            ...
            for (int i = 0; i < N; i++)
            {
                ...
                {
                    sameNumSameIndexCnt++;
                } else if(BsSet.Contains(As[i]))
                {
                    sameNumDiffIndexCnt++;
                }
            }

            Console.WriteLine(sameNumSameIndexCnt);
            Console.WriteLine(sameNumDiffIndexCnt);
        }
