    ...
    public class Solver {
        public void Solve() {
            ...
            for (int l = 0; l < N; l++)
            {
                ...
                while (goodRMax < N - 1 && As[goodRMax + 1] == 0)
                {
                    goodRMax++;
                }
                ...
                if (goodRMax - l + 1 >= K)
                {
                    for (int i = lastL; i <= goodRMax; i++)
                    {
                        lToGoodRMax[i] = goodRMax;
                    }

                    lastL = goodRMax + 1;
                }

                lToGoodRMax[l] = goodRMax;
            }
            ...
            {
                var lr = Ria();
                var l = lr[0] - 1; var r = lr[1] - 1;
                Console.WriteLine(lToGoodRMax[l] >= r ? "Yes" : "No");
            }
        }
