...
public class Solver {
    public void Solve()
    {
        ...
        if (N < 1000)
            ...
            Console.WriteLine(N / 100 * 100);
        else if (N < 1000000)
            Console.WriteLine(N / 1000 * 1000);
        else if (N < 10000000)
            Console.WriteLine(N / 10000 * 10000);
        else if (N < 100000000)
            Console.WriteLine(N / 100000 * 100000);
        else if (N < 1000000000)
            Console.WriteLine(N / 1000000 * 1000000);
    }
