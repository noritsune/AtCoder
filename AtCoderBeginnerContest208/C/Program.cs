...
namespace util {
    ...
    public class Sol{
        ...
        public void Solve(){
            ...
            // y: 国民番号
            // z: お菓子の個数
            Vector3L[] people = new Vector3L[N];
            for (int i = 0; i < N; i++)
            {
                people[i] = new Vector3L(
                    i,
                    As[i],
                    sameCnt
                );
            ...
            Array.Sort(people, (a, b) => (int)(a.y - b.y));
            ...
            Array.Sort(people, (a, b) => (int)(a.x - b.x));

            foreach (Vector3L person in people)
            {
                Console.WriteLine(person.z);
            }
