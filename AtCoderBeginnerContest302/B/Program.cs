    ...
    public void Solve() {
        ...
        for (int h = 0; h < H; h++)
        {
            for (int w = 0; w < W; w++)
            {
                ...
                for (int i = 0; i < 5; i++)
                {
                    if (w + i < W) horiStr += grid[h][w + i];
                    if (h + i < H) vertStr += grid[h + i][w];
                    if (w + i < W && h + i < H) rightDownStr += grid[h + i][w + i];
                    if (w + i < W && h - i >= 0) rightUpStr += grid[h - i][w + i];
                }
                ...
                if (rightDownStr == SNUKE)
                {
                    for (int i = 0; i < 5; i++)
                    {
                        Console.WriteLine($"{h + i + 1} {w + i + 1}");
                    }
                    return;
                }
                if (rightDownStr == EKUNS)
                {
                    for (int i = 4; i >= 0; i--)
                    {
                        Console.WriteLine($"{h + i + 1} {w + i + 1}");
