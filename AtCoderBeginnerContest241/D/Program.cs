            ...
            for (int i = 0; i < Q; i++)
            {
                ...
                switch (q[0])
                {
                    ...
                    case 2:
                        ...
                        var upperBoundIndex = As.UpperBound(x);
                        if(upperBoundIndex - k >= 0 && upperBoundIndex - k < As.Count()) {
                            Console.WriteLine(As[upperBoundIndex - k]);
                        } else {
                            Console.WriteLine(-1);
                        }
                        break;
                    case 3:
                        ...
                        var lowerBoundIndex = As.LowerBound(x);
                        if(lowerBoundIndex + k < As.Count() && lowerBoundIndex + k >= 0) {
